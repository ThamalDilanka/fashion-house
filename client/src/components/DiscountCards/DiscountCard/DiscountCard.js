							...
							<form className='was-validated'>
								<div className='form-group'>
									...
									<input
										...
										required
										onChange={(e) =>
											setUpdateNewDiscount(e.target.value)
										}
									/>
									<small
										id='discountHelp'
			...
			>
				<div className='modal-dialog'>
					<div className='modal-content'>
						<div className='modal-header'>
							<h5
								className='modal-title text-center text-danger'
						...
						<div className='modal-body'>
							<form>
								<div className='row'>
									...
									<div className='col'>{deleteDiscount}</div>
								</div>
								...
								<div className='row'>
									...
									<div className='col'>{deleteFromDate}</div>
								</div>
								...
								<div className='row'>
									...
									<div className='col'>{delteToDate}</div>
								</div>
								...
								<div className='row'>
									...
									<div className='col'>{deleteName}</div>
								</div>
							</form>
						</div>
						<div className='modal-footer'>
							...
							<button
								type='button'
								onClick={(e) => deleteItemDiscount(e)}
