      ...
      <div className="row">
        ...
        <div className="product-view-description-container col-md-8">
          ...
          <div className="single-product-view-rating d-flex">
            ...
            <p className={props.availableQuantity > 0 ? 'single-product-view-available' : 'single-product-view-not-available'}>
              {props.availableQuantity >= 15
                ? "Available"
                : ( props.availableQuantity > 0 && props.availableQuantity < 15 ? "Only " + props.availableQuantity + " Items are Available" : "Not Available")}
            </p>
          </div>
